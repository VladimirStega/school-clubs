...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      // this generates a separate chunk (About.[hash].js) for this route
      // which is lazy-loaded when the route is visited.
      component: () => import('../views/ClubLigaZnaniyView.vue')
    },
    {
      path: '/orlyata',
      name: 'orlyata',
      ...
      // this generates a separate chunk (About.[hash].js) for this route
      // which is lazy-loaded when the route is visited.
      component: () => import('../views/ClubOrlyataRossiiView.vue')
    },
    {
      path: '/bolshaia-peremena',
      name: 'bolshaia-peremena',
      // route level code-splitting
      // this generates a separate chunk (About.[hash].js) for this route
      // which is lazy-loaded when the route is visited.
      component: () => import('../views/ClubBolshaiaPeremenaView.vue')
    },
    {
      path: '/intellekt',
      name: 'intellekt',
      ...
      // this generates a separate chunk (About.[hash].js) for this route
      // which is lazy-loaded when the route is visited.
      component: () => import('../views/ClubIntellektView.vue')
    },
    {
      path: '/delayi-dobro',
      name: 'delayi-dobro',
      ...
      // this generates a separate chunk (About.[hash].js) for this route
      // which is lazy-loaded when the route is visited.
      component: () => import('../views/ClubDelayiDobroView.vue')
    },
    {
      path: '/azimyt',
      name: 'azimyt',
      ...
      // this generates a separate chunk (About.[hash].js) for this route
      // which is lazy-loaded when the route is visited.
      component: () => import('../views/ClubAzimytView.vue')
    },
    {
      path: '/unarmiya',
      name: 'unarmiya',
      ...
      // this generates a separate chunk (About.[hash].js) for this route
      // which is lazy-loaded when the route is visited.
      component: () => import('../views/ClubUnarmiyaView.vue')
    },
    {
      path: '/sodrygestvo',
      name: 'sodrygestvo',
